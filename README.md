...
<p>
<img src="img/logo.png" alt="Data Azzure logo" width="100px">
</p>
...
1.  Clone repositori ini:
    ```bash
    git clone [https://github.com/daffasdev-lang/dataazurev2.git](https://github.com/daffasdev-lang/dataazurev2.git)
    cd dataazurev2
    ```
...
3.  Edit variabel-variabel konfigurasi ini:
    ...
    ```javascript
    // --- KONFIGURASI WAJIB ---
    const N8N_WEBHOOK_URL = '[https://devdaffas-n8n-free.hf.space/webhook-test/azuredata](https://devdaffas-n8n-free.hf.space/webhook-test/azuredata)'; // <-- GANTI DENGAN URL WEBHOOK N8N ANDA
...
#Tentu, ini adalah revisi README.md Anda dengan semua elemen yang tadinya align="center" dihilangkan, sehingga konten akan rata kiri (default).
...
Buat branch fitur baru (git checkout -b fitur/perbaikan-keren).

Lakukan perubahan Anda.

Commit perubahan Anda (git commit -m 'Menambahkan fitur keren').

Push ke branch Anda (git push origin fitur/perbaikan-keren).
